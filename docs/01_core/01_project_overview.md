...
| [02_tech_stack.md](../01_core/02_tech_stack.md) | All technologies, frameworks, and dependencies |
| [03_project_structure.md](../01_core/03_project_structure.md) | Full directory layout with annotations |
| [04_flutter_architecture.md](../02_architecture/05_flutter_architecture.md) | Flutter client architecture deep-dive |
| [05_python_architecture.md](../02_architecture/06_python_architecture.md) | Python server architecture deep-dive |
| [07_developer_setup.md](../03_guides/08_developer_setup.md) | How to run from source |
| [18_github_workflow_guide.md](../03_guides/12_github_workflow_guide.md) | CI/CD pipelines, branching, and releasing |
