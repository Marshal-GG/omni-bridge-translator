...
3. Rename the resulting zip to something descriptive, e.g., `omni_bridge_v1.2.1_windows.zip`.
...
3. **Choose a tag**: Type the version number exactly as it appears in your `pubspec.yaml` (e.g., `v1.2.1`).
   - *Note: The update service expects the "v" prefix or a direct semver string.*
4. **Release title**: Give it a name, e.g., `Omni Bridge Release v1.2.1`.
