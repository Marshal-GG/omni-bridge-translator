...
The `usage` feature follows the standard **Clean Architecture (Vertical Slice)** pattern established across all features. See [19 — New Screen Setup Guide](19_new_screen_setup_guide.md) for the full pattern reference.
...
- **Color accent**: `Colors.orangeAccent` (reserved per the [Design Language Guide](19_new_screen_setup_guide.md#b-color-coding-system))
...
- [04 — Flutter Architecture](04_flutter_architecture.md) — BLoC pattern, DI, and all feature modules
- [06 — Database Schema](06_database_schema.md) — Firestore & Realtime DB schema for usage counters
- [13 — Monetization Plan](13_monetization_plan.md) — Subscription tiers, quotas, and limits
- [19 — New Screen Setup Guide](19_new_screen_setup_guide.md) — Pattern reference for adding new feature screens
