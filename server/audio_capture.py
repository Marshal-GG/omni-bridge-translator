            ...
            with pyaudio.PyAudio() as p:
                ...
                while self.is_recording:
                    ...
                    if device_info["maxInputChannels"] > 1:
                        ...
                        audio_data_int16 = audio_data_int16.reshape(-1, device_info["maxInputChannels"]).mean(axis=1).astype(np.int16)
                    ...
                    actual_frames_per_chunk = int(device_info["defaultSampleRate"] * self.chunk_duration)
                    ...
                    if len(buffer) >= actual_frames_per_chunk:
                        ...
                        self.audio_queue.put((chunk_to_process, int(device_info["defaultSampleRate"])))
