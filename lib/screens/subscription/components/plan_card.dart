...
/// Display names for model IDs shown in the plan card.
const _modelDisplayNames = {
          ...
          Wrap(
            ...
            children: plan.allowedTranslationModels.map((m) {
              ...
              final suffix = limit != null
                  ...
                  : '';
              return _ModelChip(label: '${_modelDisplayNames[m] ?? m}$suffix');
            }).toList(),
          ),
        ],
        if (plan.allowedTranscriptionModels.isNotEmpty) ...[
          ...
          Wrap(
            ...
            children: plan.allowedTranscriptionModels.map((m) {
              return _ModelChip(label: _modelDisplayNames[m] ?? m);
            }).toList(),
          ),
        ],
